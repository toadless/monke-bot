...
public class Reminders extends TableImpl<RemindersRecord> {
    ...
    /**
     * The column <code>public.reminders.channel_id</code>.
     */
    public final TableField<RemindersRecord, Long> CHANNEL_ID = createField(DSL.name("channel_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    /**
     * The column <code>public.reminders.expiry</code>.
     */
    public final TableField<RemindersRecord, LocalDateTime> EXPIRY = createField(DSL.name("expiry"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
