...
public class PrefixConfigCommand extends Command
{
    public PrefixConfigCommand(Command parent)
    {
        super(parent, "prefix", "Gets and sets the prefix for this server.", "<newPrefix {5}> / <none>");
